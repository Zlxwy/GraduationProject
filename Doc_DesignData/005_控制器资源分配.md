...
| 引脚 | 外设功能 | 连接设备 | 作用 |
| --- | --- | --- | --- |
| PB5 | GPIO_Output | StepperMotorShoulder_Dir | 肩关节电机方向信号 |
| PB4 | TIM3_CH1 | StepperMotorShoulder_Pul | 肩关节电机脉冲信号 |
| PB6 | GPIO_Output | StepperMotorElbow_Dir | 肘关节电机方向信号 |
| PB8 | TIM10_CH1 | StepperMotorElbow_Pul | 肘关节电机脉冲信号 |
| PB7 | GPIO_Output | StepperMotorLift_Dir | 竖轴电机方向信号 |
| PB9 | TIM11_CH1 | StepperMotorLift_Pul | 竖轴电机脉冲信号 |
...
| 引脚 | 外设功能 | 连接设备 | 作用 |
| --- | --- | --- | --- |
| PF0 | GPIO_Input | SIG0 | 待定 |
| PF1 | GPIO_Input | SIG1 | 待定 |
| PF2 | GPIO_Input | SIG2 | 竖轴原点限位器 |
| PF3 | GPIO_Input | SIG3 | 待定 |
...
| 引脚 | 外设功能 | 连接设备 | 作用 |
| --- | --- | --- | --- |
| PF4 | GPIO_Input | KEY0 | 按键0 |
| PF5 | GPIO_Input | KEY1 | 按键1 |
| PF6 | GPIO_Input | KEY2 | 按键2 |
| PF7 | GPIO_Input | KEY3 | 按键3 |
| PF8 | GPIO_Input | KEY4 | 按键4 |
| PF9 | GPIO_Input | KEY5 | 按键5 |
