...
import cv2
import numpy as np
# import apriltag # For arm64 Linux
import pupil_apriltags as apriltag # For x64 Windows

CAM_INDEX = 1 # 摄像头索引，0 表示默认摄像头
...
def main():
  ...
  # AprilTagDetector = apriltag.Detector(apriltag.DetectorOptions(families="tag36h11")) # For arm64 Linux
  AprilTagDetector = apriltag.Detector(families="tag36h11") # For x64 Windows
