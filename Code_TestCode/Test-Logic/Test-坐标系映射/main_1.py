...
def main():
  ...
  while True:
    ...
    cv2.circle(frame, CvPlane_Rect_TopLeft, 5, draw_color, 2)
    cv2.circle(frame, CvPlane_Rect_TopRight, 5, draw_color, 2)
    cv2.circle(frame, CvPlane_Rect_BottomRight, 5, draw_color, 2)
    cv2.circle(frame, CvPlane_Rect_BottomLeft, 5, draw_color, 2)
